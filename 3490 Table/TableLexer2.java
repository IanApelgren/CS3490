...
public class TableLexer2 {
    ...
    public static final int B_TOK = 1;
    public static final int BAB_TOK = 4;
    public static final int WS_TOK = 7;
	...
	while ( (currTok=lexer.yylex()) != EOF_TOK) {
	    switch (currTok) {
	    case WS_TOK : 
		System.out.println("Found token: WS/BA*B"); break;
	    case BAB_TOK : 
		System.out.println("Found token: BAB(BAB)*"); break;
	    case B_TOK :
	...
	while (true) {
	    ...
	    case 2: lastToken = BAB_TOK; break;
	    case 5: lastToken = WS_TOK; break;
	    case 6: 
		// "Error" state
